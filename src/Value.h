...
enum ValueType {
    ...
    * If type == input, then the value is then value is the index of the desired input-pin-number in the input-pin-number list (0 is the first input-pin-number in the list)
    * If type == systemConfig, then value is the index of the desired property in the systemConfig. (0 is the first property of systemConfig)
